// Template content for process-task-list
export const processTaskListTemplateContent = `# Task List Management

Guidelines for managing tasks lists in markdown files to track progress on completing a PRD
