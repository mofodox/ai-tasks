// Template content for generate-tasks
export const generateTasksTemplateContent = `Rule: Generating a Task List from a PRD
...
- \`path / to / another / file2.ts\` - Brief description (e.g., Another utility function).
- \`path / to / another / file2.test.ts\` - Unit tests for \`file2.ts\`.
...
Assume the primary reader of the task list is a **junior developer** who will implement the feature with awareness of the exisiting codebase context.`;